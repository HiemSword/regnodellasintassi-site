...
class Secrets
{
	...
	protected $notificationEmail = 'hiemsword08@pm.me';

	// E-mail address to use in notifications to normal users
	protected $noreplyEmail = 'ilredellasintassi@gmail.com';

	// Unique encryption key (case-sensitive)
	protected $encryptionKey = 'hiemL091';
	...
	// SMTP server user
	protected $smtpUser = 'ilredellasintassi@gmail.com';

	// SMTP server password
	protected $smtpPassword = 'VivaIBotSintassi';
}
